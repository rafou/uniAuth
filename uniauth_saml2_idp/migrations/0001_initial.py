    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attribute_processor', models.CharField(blank=True, default='uniauth_saml2_idp.base.processors.BaseProcessor', help_text='"package.file.classname", example: "uniauth_saml2_idp.base.processors.BaseProcessor"', max_length=256)),
