# Generated by Django 3.2.20 on 2023-09-28 08:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agreement_screen', models.BooleanField(default=False)),
                ...
                ('attribute_processor', models.CharField(blank=True, default='uniauth_saml2_idp.processors.base.BaseProcessor', help_text='"package.file.classname", example: "uniauth_saml2_idp.processors.base.BaseProcessor"', max_length=256)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('sp', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='uniauth_saml2_idp.serviceprovider')),
